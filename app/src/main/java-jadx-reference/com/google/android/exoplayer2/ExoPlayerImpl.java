    ...
    public void prepare(MediaSource mediaSource, boolean resetPosition, boolean resetState) {
        if (resetState) {
            ...
            if (this.tracksSelected) {
                ...
                for (ExoPlayer.EventListener listener2 : this.listeners) {
        ...
        switch (msg.what) {
            ...
            case 3:
                if (this.pendingPrepareAcks == 0) {
                    ...
                    for (ExoPlayer.EventListener listener3 : this.listeners) {
            ...
            case 4:
                ...
                if (i == 0) {
                    ...
                    if (msg.arg1 != 0) {
                        for (ExoPlayer.EventListener listener4 : this.listeners) {
            ...
            case 5:
                if (this.pendingSeekAcks == 0) {
                    this.playbackInfo = (ExoPlayerImplInternal.PlaybackInfo) msg.obj;
                    for (ExoPlayer.EventListener listener5 : this.listeners) {
            ...
            case 6:
                ...
                if (this.pendingPrepareAcks == 0) {
                    ...
                    for (ExoPlayer.EventListener listener6 : this.listeners) {
            ...
            case 7:
                ...
                if (!this.playbackParameters.equals(playbackParameters)) {
                    ...
                    for (ExoPlayer.EventListener listener7 : this.listeners) {
            ...
            case 8:
                ...
                for (ExoPlayer.EventListener listener8 : this.listeners) {
