...
public final class MatroskaExtractor implements Extractor {
    ...
    private static void setSubripSampleEndTimecode(byte[] subripSampleData, long timeUs) {
        ...
        if (timeUs == C.TIME_UNSET) {
            ...
            int milliseconds = (int) ((timeUs3 - ((long) (1000000 * seconds))) / 1000);
        ...
        public void initializeOutput(ExtractorOutput output, int trackId) throws ParserException {
            ...
            switch (b) {
                ...
                case 5:
                    ...
                    initializationData = this.codecPrivate != null ? Collections.singletonList(this.codecPrivate) : null;
                    break;
                case 6:
                ...
                case 8:
                    ...
                    mimeType = initializationData != null ? MimeTypes.VIDEO_VC1 : MimeTypes.VIDEO_UNKNOWN;
                    break;
                case 9:
