            ...
            if (specialCount > 0) {
                ...
                if (specialCount == 1) {
                    if (lastSpecial == 8232) {
                        ...
                        this.buf[lastSpecialIndex2] = org.apache.commons.io.IOUtils.DIR_SEPARATOR_WINDOWS;
                        ...
                        if (ch5 < IOUtils.specicalFlags_doubleQuotes.length && IOUtils.specicalFlags_doubleQuotes[ch5] == 4) {
                            ...
                            this.buf[bufIndex3] = IOUtils.DIGITS[(ch5 >>> '\f') & 15];
                            int bufIndex5 = bufIndex4 + 1;
                            this.buf[bufIndex4] = IOUtils.DIGITS[(ch5 >>> '\b') & 15];
                            ...
                            this.buf[lastSpecialIndex2] = org.apache.commons.io.IOUtils.DIR_SEPARATOR_WINDOWS;
                            this.buf[lastSpecialIndex2 + 1] = IOUtils.replaceChars[ch5];
                        }
                    }
                    ...
                    for (int i6 = textIndex; i6 < text.length(); i6++) {
                        char ch6 = text.charAt(i6);
                        if ((ch6 < IOUtils.specicalFlags_doubleQuotes.length && IOUtils.specicalFlags_doubleQuotes[ch6] != 0) || (ch6 == '/' && isEnabled(SerializerFeature.WriteSlashAsSpecial))) {
                            int bufIndex8 = bufIndex7 + 1;
                            this.buf[bufIndex7] = org.apache.commons.io.IOUtils.DIR_SEPARATOR_WINDOWS;
                            if (IOUtils.specicalFlags_doubleQuotes[ch6] == 4) {
                                int bufIndex9 = bufIndex8 + 1;
                                this.buf[bufIndex8] = 'u';
                                int bufIndex10 = bufIndex9 + 1;
                                this.buf[bufIndex9] = IOUtils.DIGITS[(ch6 >>> '\f') & 15];
                                int bufIndex11 = bufIndex10 + 1;
                                this.buf[bufIndex10] = IOUtils.DIGITS[(ch6 >>> '\b') & 15];
                                int bufIndex12 = bufIndex11 + 1;
                                this.buf[bufIndex11] = IOUtils.DIGITS[(ch6 >>> 4) & 15];
                                bufIndex7 = bufIndex12 + 1;
                                this.buf[bufIndex12] = IOUtils.DIGITS[ch6 & 15];
                                end += 5;
                            } else {
                                bufIndex7 = bufIndex8 + 1;
                                this.buf[bufIndex8] = IOUtils.replaceChars[ch6];
                                end++;
                            }
                        } else if (ch6 == 8232) {
                            ...
                            this.buf[bufIndex14] = IOUtils.DIGITS[(ch6 >>> '\f') & 15];
                            int bufIndex16 = bufIndex15 + 1;
                            this.buf[bufIndex15] = IOUtils.DIGITS[(ch6 >>> '\b') & 15];
