            ...
            try {
                ...
                if (key == JSON.DEFAULT_TYPE_KEY) {
                    ...
                    if (object.getClass() == JSONObject.class) {
                        key = key == null ? JniUscClient.az : key.toString();
                    }
                    if (ch3 == '\"') {
                        lexer.scanString();
                        String strValue = lexer.stringVal();
                        Object time = strValue;
                        ...
                        lexer.scanNumber();
                        Number value = lexer.token() == 2 ? lexer.integerValue() : lexer.decimalValue(isEnabled(Feature.UseBigDecimal));
