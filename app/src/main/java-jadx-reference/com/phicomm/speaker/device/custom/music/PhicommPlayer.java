...
public class PhicommPlayer implements CommonPlayer {
    ...
    public void queryPlayItem(final int page) {
        int type;
        type = -1;
        switch (this.mDevicePlayingType) {
            case "news":
                type = 3;
                break;
            case "audio":
        ...
        if (type != -1) {
            ...
            this.mMainHandler.post(new Runnable() { // from class: com.phicomm.speaker.device.custom.music.PhicommPlayer.1
