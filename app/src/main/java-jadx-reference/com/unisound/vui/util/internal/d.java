...
public final class d extends Random {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:18:0x0079, code lost:
        ...
        r0 = ((((((((((long) r0[0]) & 255) << 56) | ((((long) r0[1]) & 255) << 48)) | ((((long) r0[2]) & 255) << 40)) | ((((long) r0[3]) & 255) << 32)) | ((((long) r0[4]) & 255) << 24)) | ((((long) r0[5]) & 255) << 16)) | ((((long) r0[6]) & 255) << 8)) | (((long) r0[7]) & 255);
        r2 = false;
     */
    /*
    ...
    */
    public static long a() {
        ...
        synchronized (d.class) {
            ...
            long nanos = TimeUnit.SECONDS.toNanos(3L) + f;
            while (true) {
                ...
                if (jNanoTime <= 0) {
                    try {
                        ...
                        LogMgr.d("ThreadLocalRandom", "Failed to generate a seed from SecureRandom due to an InterruptedException.");
                        j = j3;
                        z = true;
                    }
                } else {
                    bArrPoll = e.poll(jNanoTime, TimeUnit.NANOSECONDS);
                }
                if (bArrPoll != null) {
                    break;
                }
                if (jNanoTime <= 0) {
                    d.interrupt();
                    LogMgr.d("ThreadLocalRandom", "Failed to generate a seed from SecureRandom within %d seconds Not enough entrophy?", 3L);
                    j = j3;
                    z = false;
                    break;
                }
            }
            long jReverse = (j ^ 3627065505421648153L) ^ Long.reverse(System.nanoTime());
            c = jReverse;
            if (z) {
