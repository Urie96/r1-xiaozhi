...
public class SpeakerTTSUtil {
    ...
    private static String getRadom(String s) {
        ...
        return strArrSplit.length > 1 ? strArrSplit[(int) (Math.random() * ((double) strArrSplit.length))] : strArrSplit[0];
    }
    ...
    public static String getTTSStringFromArray(int id, Context context) {
        ...
        String[] strArrSplit = tTSStringArray[(int) (Math.random() * ((double) tTSStringArray.length))].split(MqttTopic.MULTI_LEVEL_WILDCARD);
