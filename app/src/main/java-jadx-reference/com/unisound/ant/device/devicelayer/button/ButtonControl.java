...
public class ButtonControl {
    ...
    public void nextMusic() {
        NLU<SettingExtIntent, Result> controlNlu = getControlNlu(Operator.ACT_NEXT, new String[0]);
        if (this.ctx != null) {
            this.ctx.pipeline().fireUserEventTriggered(controlNlu);
        } else {
    ...
    public void prevMusic() {
        NLU<SettingExtIntent, Result> controlNlu = getControlNlu(Operator.ACT_PREV, new String[0]);
        if (this.ctx != null) {
            this.ctx.pipeline().fireUserEventTriggered(controlNlu);
        } else {
            LogMgr.e("-->>ctx is null");
    ...
    public void pauseMusic() {
        NLU<SettingExtIntent, Result> controlNlu = getControlNlu(Operator.ACT_PAUSE, new String[0]);
        if (this.ctx != null) {
            this.ctx.pipeline().fireUserEventTriggered(controlNlu);
        } else {
            LogMgr.e("-->>ctx is null");
    ...
    public void playMusic() {
        NLU<SettingExtIntent, Result> controlNlu = getControlNlu("ACT_PLAY", new String[0]);
        if (this.ctx != null) {
            this.ctx.pipeline().fireUserEventTriggered(controlNlu);
        } else {
            LogMgr.e("-->>ctx is null");
    ...
    public void collectMusic(boolean isCollect) {
        NLU<SettingExtIntent, Result> controlNlu;
        if (isCollect) {
            controlNlu = getControlNlu(Operator.ACT_BOOKMARK, new String[0]);
        } else {
            controlNlu = getControlNlu(Operator.ACT_BOOKMARK, Operator.ACT_CANCEL);
        }
        if (this.ctx != null) {
            this.ctx.pipeline().fireUserEventTriggered(controlNlu);
        } else {
    ...
    public void switchTo(String itemId) {
        NLU<SettingExtIntent, Result> controlNlu = getControlNlu(Operator.ACT_SWITCH, itemId);
        if (this.ctx != null) {
            this.ctx.pipeline().fireUserEventTriggered(controlNlu);
        } else {
            LogMgr.e("-->>ctx is null");
    ...
    public void playMusicListWithIndex(String musicData) {
        NLU<SettingExtIntent, Result> controlNlu = getControlNlu(Operator.ACT_PLAY_LIST, musicData);
        if (this.ctx != null) {
            this.ctx.pipeline().fireUserEventTriggered(controlNlu);
        } else {
            LogMgr.e("-->>ctx is null");
    ...
    public void playAudioListWithIndex(String audioListJson) {
        NLU<SettingExtIntent, Result> controlNlu = getControlNlu(Operator.ACT_PLAY_AUDIO_LIST, audioListJson);
        if (this.ctx != null) {
            this.ctx.pipeline().fireUserEventTriggered(controlNlu);
        } else {
            LogMgr.e("-->>ctx is null");
