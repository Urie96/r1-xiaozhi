...
public class an extends Thread {
    ...
    */
    public void run() throws Throwable {
        long length;
        com.unisound.common.y.c("NetRecogniton -> run start");
        if (com.unisound.common.y.l) {
            com.unisound.common.y.d("RecognitionThread -> ThreadName = ", Thread.currentThread().getName(), ", ThreadId = ", Long.valueOf(Thread.currentThread().getId()));
        }
        com.unisound.common.y.g("RecognitionThread start");
        ...
        if (iA != 0) {
            com.unisound.common.y.a("start", com.unisound.common.y.I, (Map<String, String>) null, (String) null, String.valueOf(iA), (String) null);
            com.unisound.common.y.c("NetRecognition --> start error occured! , startCode = ", Integer.valueOf(iA), ", sessionId = ", this.f);
            a(iA, jniUscClient);
            jniUscClient.e();
            this.e.bc();
            return;
        }
        com.unisound.common.y.a("start", com.unisound.common.y.J, (Map<String, String>) null, (String) null, (String) null, (String) null);
        if (d()) {
            jniUscClient.d();
            com.unisound.common.y.a("cancel", (String) null, (Map<String, String>) null, (String) null, (String) null, "cancel(start)");
            com.unisound.common.y.c("NetRecognition --> cancel(start)");
            jniUscClient.e();
            return;
        }
        long j = 0;
        while (true) {
            try {
                ...
                if (bArrPoll == null) {
                    ...
                    if (!this.e.al() || !this.e.an()) {
                        if (!this.g && this.c.isEmpty()) {
                            com.unisound.common.y.c("NetRecognition --> break");
                            break;
                        } else {
                            if (!d()) {
                                jniUscClient.d();
                                com.unisound.common.y.a(com.unisound.common.y.E, (String) null, (Map<String, String>) null, (String) null, (String) null, "cancel(recognizer)");
                                com.unisound.common.y.c("NetRecognition --> cancel(recognizer)");
                                jniUscClient.e();
                                return;
                            }
                            j = length;
                    ...
                    int iA2 = !d() ? jniUscClient.a(bArrPoll, bArrPoll.length) : 0;
                    if (this.e.ar()) {
                        String strAs = this.e.as();
                        if (!TextUtils.isEmpty(strAs)) {
                            com.unisound.common.j.a(bArrPoll, strAs + File.separator + this.e.bj() + ".wav");
                        }
                    }
                    if (com.unisound.common.y.q) {
                        com.unisound.common.j.a(bArrPoll, "/sdcard/asrtest/oneshotonline.pcm");
                    }
                    length = ((long) bArrPoll.length) + j;
                    if (iA2 >= 0 && iA2 != 5) {
                        a(jniUscClient, this.f, false);
                    } else if (iA2 == 5) {
                        com.unisound.common.y.c("NetRecognition --> server vad stop");
                        f();
                    } else if (iA2 == -30002) {
                        com.unisound.common.y.a(com.unisound.common.y.E, (String) null, (Map<String, String>) null, (String) null, (String) null, "max speech timeout");
                        com.unisound.common.y.c("NetRecognition --> max speech timeout");
                        f(jniUscClient);
                    } else if (iA2 == -30001) {
                        com.unisound.common.y.a(com.unisound.common.y.E, (String) null, (Map<String, String>) null, (String) null, (String) null, "vad timeout");
                        com.unisound.common.y.c("NetRecognition --> vad timeout");
                    } else if (iA2 != -91155 || !this.e.an()) {
                        break;
                    } else if (g(jniUscClient) != 0) {
                        break;
                    }
                    if (!this.e.al()) {
                        if (!this.g) {
                ...
                com.unisound.common.y.a("NetRecognition --> exception");
                com.unisound.common.y.a(com.unisound.common.y.E, com.unisound.common.y.I, (Map<String, String>) null, (String) null, String.valueOf(ErrorCode.RECOGNITION_EXCEPTION), "recognition exception");
                a(ErrorCode.RECOGNITION_EXCEPTION, jniUscClient);
                JniUscClient.l = ErrorCode.RECOGNITION_EXCEPTION;
                JniUscClient.m = 0;
                jniUscClient.e();
                return;
            }
