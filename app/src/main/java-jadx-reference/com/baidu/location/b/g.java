...
public class g {
    ...
    public static boolean a(f fVar, f fVar2, float f) {
            ...
            if (str == null) {
                ...
                while (true) {
                    ...
                    if (str.equals(list2.get(i5).BSSID)) {
                        i = i3 + 1;
                        j2 += (long) ((list.get(i4).level - list2.get(i5).level) * (list.get(i4).level - list2.get(i5).level));
                        break;
                    }
                    i5++;
                }
                if (i5 == size2) {
                    ...
                    j = ((long) ((list.get(i4).level + 100) * (list.get(i4).level + 100))) + j2;
                    i2 = i;
                } else {
                    j = j2;
                    i2 = i;
        ...
        double dSqrt = Math.sqrt(j2) / ((double) size);
