...
public class b {
    ...
    private CellLocation a(List<?> list) {
        ...
        while (true) {
            ...
            if (obj != null) {
                try {
                    ...
                    c2 = clsLoadClass.isInstance(obj) ? (char) 1 : clsLoadClass2.isInstance(obj) ? (char) 2 : clsLoadClass3.isInstance(obj) ? (char) 3 : clsLoadClass4.isInstance(obj) ? (char) 4 : (char) 0;
                    if (c2 > 0) {
                        Object objCast = null;
                        if (c2 == 1) {
                            try {
        ...
        return c2 != 4 ? gsmCellLocation : cdmaCellLocation;
    }
    ...
    public String b(com.baidu.location.b.a aVar) {
        ...
        if (aVar.e < Integer.MAX_VALUE && aVar.f < Integer.MAX_VALUE) {
            stringBuffer.append(String.format(Locale.CHINA, "&cdmall=%.6f|%.6f", Double.valueOf(((double) aVar.f) / 14400.0d), Double.valueOf(((double) aVar.e) / 14400.0d)));
        }
