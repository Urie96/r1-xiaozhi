...
import com.phicomm.speaker.device.custom.handler.XiaoZhiHandler;
...
public final class ExampleANTEngineInitializer extends ANTEngineInitializer {
    ...
    protected void onEngineInitDone(ANTEngine engine) {
        ...
        // 魔改: XiaoZhi Handler, 优先级 1000, 拦截所有 NLU, 接入 xiaozhi-server-rs
        pipeline.addLast(new XiaoZhiHandler());
